...
//    private fun isDataLoaded(category: String): Boolean {
//        return when (category) {
//            MovieCategory.NOW_PLAYING -> movieListState.value.nowPlayingMovieList.isNotEmpty()
//            MovieCategory.POPULAR -> movieListState.value.popularMovieList.isNotEmpty()
//            MovieCategory.TOP_RATED -> movieListState.value.topRatedMovieList.isNotEmpty()
//            MovieCategory.UPCOMING -> movieListState.value.upcomingMovieList.isNotEmpty()
//            else -> false
//        }
//    }
}